...
namespace TechWorldSystem
{
    public partial class Form1 : Form
    {
        ...
        {
            string url = "https://localhost:7291/api/Product";
        ...
        {
            string url = "https://localhost:7292/api/Products";
            HttpClient client = new HttpClient();
            Product p = new Product();
            p.GlobalId = int.Parse(ProductGlobalIdtxt.Text);
            p.Name = ProductNametxt.Text;
            p.UnitPrice = decimal.Parse(textBox_UnitPrice.Text);
            p.StockAvailable = int.Parse(textBox_StockAvailable.Text);
            p.EstimatedDeliveryDays = int.Parse(textBox_EstimatedDeliveryDays.Text);
        ...
        {
            string url = "https://localhost:7099/api/Product" + ProductIdtxt.Text;
            HttpClient client = new HttpClient();
